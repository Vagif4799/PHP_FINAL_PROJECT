        ...
        <main>
            <div class="container-fluid">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">New One</li>
                </ol>
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="" rows="3" class="form-control" readonly>
                            {!! $article->description !!}
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Content</label>
                        <textarea name="article_content" id="" rows="3" class="form-control" readonly>
                            {!! $article->content !!}
                        </textarea>
                    </div>
                    <div class="form-group">
